...
class Generator(nn.Module):
    ...
    def __init__(self):
        ...
        self.deconv3 = nn.ConvTranspose2d(channels[2], channels[3], kernel_size= 4, stride= 4)
        self.deconv4 = nn.ConvTranspose2d(channels[3], channels[4], kernel_size= 4, stride= 4)
